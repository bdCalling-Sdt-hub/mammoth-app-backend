...
router.patch("/doc/:id",auth(USER_ROLES.DOCTOR,USER_ROLES.PATHOLOGIST),fileUploadHandler(),ReportController.uploadDocuments)

router.delete("/doc/:id",auth(USER_ROLES.ADMIN,USER_ROLES.DOCTOR,USER_ROLES.PATHOLOGIST),ReportController.deleteDocuments)

router.put("/biopsy/:id",auth(USER_ROLES.DOCTOR,USER_ROLES.PATHOLOGIST),validateRequest(ReportValidation.updateBiopsySamplesZodSchema),ReportController.updateBiopsySamples)
